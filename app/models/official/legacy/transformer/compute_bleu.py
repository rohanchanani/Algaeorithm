...
"""Script to compute models.official BLEU score.
...
from models.official.legacy.transformer.utils import metrics
...
def bleu_tokenize(string):
  r"""Tokenize a string following the models.official BLEU implementation.
